...
<div style="width: 80vw; margin: 0 auto">
    ...
    <form method="post" action="/create">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nameFood" placeholder="Nhập tên món ăn" name="nameFood" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="description" name="description" placeholder="Mô tả" rows="3" required></textarea>
        </div>
<%--        <div class="form-group">--%>
<%--            <label for="thumbnail">Link ảnh đại diện</label>--%>
<%--            <input type="text" class="form-control" id="thumbnail" placeholder="Nhập link ảnh" name="thumbnail" required>--%>
<%--        </div>--%>
        ...
        <div class="form-group">
            ...
            <input hidden type="text" name="picture" id="picture" value="">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" name="sellStartAt" placeholder="Nhập ngày bán" required>
        </div>
        <div class="form-group">
